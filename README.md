...
U-Net model with VGG16 encoder (pretrained ImageNet weights optionally usable)

Training for 30 epochs on SUIM

Mask visualization saved after each epoch

Inference notebook / script for testing the trained model
